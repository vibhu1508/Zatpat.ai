...
/** Guardrails panel — shows backend guardrails with live hit counts and add-your-own composer. */
export default function GuardrailSheet({
  ...
  return (
    <Sheet
      title="Guardrails"
      subtitle="Input and output rails run on every query. Input guardrails check language, PII, injection, and blocked topics. Output guardrails verify confidence and groundedness."
      onClose={onClose}
    >
