          ...
          <div className="sec__head">
            ...
            <div>
              ...
              <p>
                ...
                and sends it to the index that suits it. Four strategies are indexed in parallel; the router
                selects based on passage length and query type.
              </p>
            </div>
          </div>
            ...
            {STRATEGIES.map((s) => (
              <div className="cell" key={s.id}>
                ...
                <div className="cell__bar">
                  <div className="cap">
                    <span className="label">{s.threshold}</span>
